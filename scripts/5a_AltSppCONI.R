...
land_covars_reduced <- c("shrub_scrub_base", "grassland_base", 
                         "developed_lower_base", "developed_upper_base", 
                         "forest_total_base", "pasture_base", "cropland_base",
                         
                         
                         "shrub_scrub_diff", "grassland_diff",
                         "developed_total_diff", "forest_total_diff", 
                         "pasture_diff", "cropland_diff", "pasture_crop_diff")

covars_numeric_reduced <- c(stable_covars_reduced, land_covars_reduced, climate_covars_all)
...
land_covars_reduced <- c("shrub_scrub_base", "grassland_base", "developed_total_base", 
                         ...
                         "shrub_scrub_diff", "pasture_crop_diff")
